...
/// Storage: ~/Library/Application Support/ReDock/layouts/
final class LayoutStore {
    private static let logger = Logger(subsystem: "com.ReDock.app", category: "LayoutStore")
    ...
    init(directory: URL? = nil) {
        if let directory {
            ...
            self.directory = appSupport.appendingPathComponent("ReDock/layouts", isDirectory: true)
        }
