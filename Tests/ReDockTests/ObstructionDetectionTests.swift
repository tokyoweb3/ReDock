...
struct ObstructionDetectionTests {
    ...
    func singleCoverFull() {
        ...
        let result = LayoutService.obstructedWindowIndices(
    ...
    func emptyWindows() {
        let result = LayoutService.obstructedWindowIndices(from: [])
    ...
    /// obstruction logic through index-based fallback ordering.
